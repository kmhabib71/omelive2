...
function Home() {
  ...
  const createOffer = useCallback(
    ...
    [localStream, username] // Dependencies for createOffer
  );
        ...
        <div className="upper-part flex w-full  h-[75vh] ">
          <div className="left-video w-1/2 relative">
            ...
            <div className="buttons flex justify-between bg-[#e2e2e2]">
              ...
              <div className="start bg-[#f1b29f] flex items-center justify-center w-1/4 h-[9.5rem] rounded ml-2 mt-2 mb-2 text-white text-2xl cursor-pointer">
